...
class KtBodyToken(override val value: String,
                  private val expressions : MutableList<KtExpressionToken> = ArrayList(),
                  private val ifTokens : MutableList<KtIfToken> = ArrayList(),
                  private val forTokens : MutableList<KtForToken> = ArrayList(),
                  private val returnTokens : MutableList<KtReturnToken> = ArrayList(),
    ...
    override val process : (LinkedList<String>) -> Unit = { lines ->
        ...
        when {
            ...
            "^$FOR".toRegex().containsMatchIn(line) -> {
                val deletedSignature: String = lines.removeAt(0)
